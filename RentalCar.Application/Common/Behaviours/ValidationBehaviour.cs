...
using MediatR;
using RentalCar.Application.Common.Extensions;
using ValidationException = RentalCar.Application.Common.Exceptions.ValidationException;

namespace RentalCar.Application.Common.Behaviours;
